...
$sql="SELECT `petswaydatabase`.`petorders`.petOrderID,`petswaydatabase`.`petorders`.petOrderDate, `petswaydatabase`.`petorders`.petID, `petswaydatabase`.`pets`.petType, `petswaydatabase`.`pets`.petBreed, `petswaydatabase`.`pets`.petPrice,`petswaydatabase`.`petorders`.custID, `petswaydatabase`.`customernew`.custFirstName,`petswaydatabase`.`customernew`.custLastName,`petswaydatabase`.`customernew`.custContactNum FROM `petswaydatabase`.`petorders`, `petswaydatabase`.`pets`,`petswaydatabase`.`customernew` WHERE (`petswaydatabase`.`customernew`.custID = `petswaydatabase`.`petorders`.custID AND `petswaydatabase`.`petOrders`.petID=`petswaydatabase`.`pets`.petID AND `petswaydatabase`.`pets`.petType='Dog');";
