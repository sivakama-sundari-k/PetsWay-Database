...
$insert=false;
    ...
    $sql="SELECT * from `petswaydatabase`.`products` WHERE `petswaydatabase`.`products`.availableQuantity>0";
    ...
    if(!isset($_POST['productCost']) && !isset($_POST['productCategoryName'])) {
        header("location:dogproductresults.php");
        exit();
    }
