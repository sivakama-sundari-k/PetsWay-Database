...
$insert=false;
    ...
    $sql="SELECT * FROM `petswaydatabase`.`pets`,`petswaydatabase`.`petcategories` WHERE `petswaydatabase`.`pets`.petCategoryID= `petswaydatabase`.`petcategories`.petCategoryID AND `petswaydatabase`.`petcategories`.petcategoryName='Cat';";
...
filter_alt
        ...
        <form action="catFilter.php" method="post">
    ...
    margin-bottom: 18px;"> <option disabled value="" selected hidden style ="color:black;">Select Breed</option>
        <?php
        $sqlbreeds="SELECT DISTINCT `petswaydatabase`.`pets`.petBreed FROM `petswaydatabase`.`pets` WHERE `petType`='Cat';";
    ...
    margin-bottom: 18px;"> <option disabled value="" selected hidden style ="color:black;">Select Gender</option>
        <?php
        $sqlgender="SELECT DISTINCT `petswaydatabase`.`pets`.petGender FROM `petswaydatabase`.`pets` WHERE `petType`='Cat';";
    ...
    margin-bottom: 18px;"> <option disabled value="" selected hidden style ="color:black;">Select Age</option>
        <?php
        $sqlage="SELECT DISTINCT `petswaydatabase`.`pets`.petAge FROM `petswaydatabase`.`pets` WHERE `petType`='Cat';";
    ...
    margin-bottom: 18px;"> <option disabled value="" selected hidden style ="color:black;">Select Price</option>
        <?php
        $sqlprice="SELECT DISTINCT `petswaydatabase`.`pets`.petPrice FROM `petswaydatabase`.`pets` WHERE `petType`='Cat';";
...
search
    ...
    <?php 
        ...
        <img src="petImage\<?php echo $rows["petImage"]; ?>" class="image" style="height: 300px; width: 250px; display: inline-block;margin-top:70px;">
