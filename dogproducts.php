...
menu 
            ...
            <div class="dropdown-content" style="text-align: left;word-spacing:4px;">
                <a href="adddogproduct.php" style="white-space:pre-line;">Add a New Dog Product</a>
                <a href="archivedogproduct.php">Modify available Dog Products</a>
                <a href="deletedogproduct.php">Delete a Dog Product from the Inventory</a>
            </div>
        </div>
         Dog Products Inventory     
    </div>
