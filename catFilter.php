...
$insert=false;
    ...
    $sql="SELECT * from `petswaydatabase`.`pets` WHERE `petswaydatabase`.`pets`.petType='Cat' AND NOT `petswaydatabase`.`pets`.petStatus='sold'";
    ...
    if(!isset($_POST['petAge']) && !isset($_POST['petPrice']) && !isset($_POST['petGender']) && !isset($_POST['petBreed']))
    {
