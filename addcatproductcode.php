...
if(isset($_POST['productName'])){
    ...
    $tempname = $_FILES["productImage"]["tmp_name"];     
        ...
        if (move_uploaded_file($tempname, $folder))  { 
           ...
           $sql = "INSERT INTO `petswaydatabase`.`products`(`productName`, `availableQuantity`, `productCost`, `productCategoryID`,`productImage`,`productStatus`,`productDesc`) VALUES ('$productName', '$availableQuantity', '$productCost', '$productCategoryID','$filename','available','$productDesc');"; // backtick and NOT SINGLE QUOTE!!!
