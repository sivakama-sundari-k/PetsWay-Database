...
<div style =" word-spacing: 7px;
  ...
  <div class="grid-item" style="background-color: #0d0d0d;
    text-align: center;">
    <img style="width:250px; height:300px;" src="productImage\<?php echo $row["productImage"]; ?>" alt="image">
</div>
<form action="productOrderSuccess.php" method="post">
    <div class="grid-item" style="background-color: whitesmoke;
    padding-left: 58px;padding-right:58px;width:90%;
    padding-top: 40px; padding-bottom: 40px;">
     <h1 style="text-align: center; opacity: 50%;">Transaction <span class="material-icons" style="color:black;font-size:29px;">
payment
</span></h1>
        ...
        <input type="text" style ="width:25%;" name="expiry" id="expiry" placeholder="Enter month" pattern="[0-9]{,2}" required> <br>
         <input type="text" style ="width: 25%;
    margin-left: 17px;
    display: inline;" name="expiry" id="expiry" placeholder="Enter year" pattern="[0-9]{2}" required> <br>
    </div>
        <input type="hidden" name="productID" id="productID" value= <?php echo $productID; ?>> <br>
        <input type="hidden" name="custID" id="custID" value= <?php echo $row1["custID"];?> > <br>
        <div style="text-align:center;">
        <button class="text" type ="submit" style="word-spacing: normal;"> Pay Rs. <?php echo $row["productCost"]; ?> Now  </button> </div>
