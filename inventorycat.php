...
menu 
            ...
            <div class="dropdown-content" style="text-align: left;word-spacing:4px;">
                ...
                <a href="archivecat.php">Archive a Cat</a>
            </div>
        </div>
         Cat Inventory     
    </div>
...
<?php
    ...
    <tr>
            ...
            <td> <img src="petImage\<?php echo $rows["petImage"]; ?>" alt="image"></td>
        </tr>
...
store
  ...
  <div class="grid-item">Contact <br> <br>
            <a href="mailto:sivakamasundarik@gmail.com"> <span class="material-icons">
mail
