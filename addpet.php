...
if(isset($_POST['petName'])){
    ...
    $petAge=$_POST['petAge'];
    $petCategoryID=$_POST['petCategoryID'];
    ...
    $sql = "INSERT INTO `petswaydatabase`.`pets`(`petType`, `petName`, `petBreed`, `petPrice`, `petAge`, `petCategoryID`, `petGender`,`petImage`,`petDesc`,`petStatus`) VALUES ('$petType', '$petName', '$petBreed', '$petPrice', '$petAge','$petCategoryID', '$petGender','$filename','$petDesc','$petStatus');"; // backtick and NOT SINGLE QUOTE!!!
...
<div class="container" style="align-items: center; text-align: center; align-content: center;">
    ...
    <form action="addpet.php" class="Registration Form" method="post" id="form" enctype="multipart/form-data">
        <label for="petCategoryID">Pet Category ID </label>
        <select name="petCategoryID" id="petCategoryID" style="width: -webkit-fill-available; color:black; padding: 12px;background-color:white;
    margin-top: 11px;
    font-size: inherit;
    margin-bottom: 18px;"> <option disabled value="" selected hidden style ="color:black;">Select pet category</option>
                <option value="1" style ="color:black;">1 - Large Breed</option>
            <option value="2" style ="color:black;">2 - Small Breed</option>          </select> <br>
    ...
    margin-bottom: 18px;"> <option disabled value="" selected hidden style ="color:black;">Select Gender</option>
            ...
            <option value="F" style ="color:black;">Female</option> </select><br>
        ...
        <label for="petDesc">Description: </label> <br>
        <input type="text" name="petDesc" id="petDesc" placeholder="Enter pet description here" 
         required> <br>
        
        <label for="petPrice">Pet Price: </label> <br>
        <input type="number" name="petPrice" id="petPrice" placeholder="Enter price" required> <br>
        
        <button type="submit" class = "register" style="margin-left: 195px;
    margin-top: 13px;
    padding: 5px;
    width: 79px;"> Add <span class="material-icons">
add</span> </button>
    </form>
    </div>
