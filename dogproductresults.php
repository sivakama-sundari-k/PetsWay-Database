...
filter_alt
        ...
        <form action="dogProductFilter.php" method="post">
    ...
    margin-bottom: 18px;"> <option disabled value="" selected hidden style ="color:black;">Select Product Category</option>
        <?php
        $sqlpcat="SELECT * from `petswaydatabase`.`productcategories` where `petswaydatabase`.`productcategories`.petType='Dog';";
    ...
    margin-bottom: 18px;"> <option disabled value="" selected hidden style ="color:black;">Select Product Cost</option>
        <?php
        $sqlcost="SELECT DISTINCT `petswaydatabase`.`products`.productCost FROM `petswaydatabase`.`products`, `petswaydatabase`.`productcategories` WHERE `petswaydatabase`.`products`.productCategoryID=`petswaydatabase`.`productcategories`.productCategoryID AND `petswaydatabase`.`productcategories`.petType='Dog';";
