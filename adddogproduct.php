...
<div class="container" style="align-items: center; text-align: center; align-content: center;">
    ...
    <form action="adddogproductcode.php" method="post" id="form" enctype="multipart/form-data">
    ...
    if(!$con){
        die("connection to this  database failed due to " . mysqli_connect_error());
            ...
            $sql2="SELECT * FROM `petswaydatabase`.`productcategories` WHERE `petswaydatabase`.`productcategories`.petType='Dog';";
            $res2=$con->query($sql2);
