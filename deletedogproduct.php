...
<?php
    ...
    $sql = "SELECT * FROM `petswaydatabase`.`products`, `petswaydatabase`.`productcategories` WHERE (`petswaydatabase`.`products`.productCategoryID = `petswaydatabase`.`productcategories`.productCategoryID AND `petswaydatabase`.`productcategories`.petType='Dog');";
...
<div style =" word-spacing: 7px;
    ...
    font-size: xx-large;
    margin-top: 95px;"> 
         Delete a Dog Product from the Inventory 
   
    </div>
<div class="container" style="align-items: center; text-align: center; align-content: center;">
    
    
    <form action = "deletedogproductcode.php " method = "post">
